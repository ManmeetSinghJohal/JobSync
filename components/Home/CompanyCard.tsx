  ...
  return (
    <div className="flex h-full flex-col justify-between rounded-[10px] bg-white p-5 shadow dark:bg-darkBg-2  xl:mb-[60px] xl:h-[216px]">
      ...
      {vacancies > 1 ? (
        ...
        <Button
          className="mt-2 flex h-[44px] w-full cursor-not-allowed gap-2.5 self-center rounded-[10px] bg-natural-4 px-3.5 py-3 text-sm font-bold leading-normal text-natural-6 opacity-50 dark:bg-darkBg-3"
          disabled
        >
          See All
        </Button>
