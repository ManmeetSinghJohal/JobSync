...
import CompanyCardCompanyLogo from "@/components/Home/CompanyCardCompanyLogo";
import { CompanyCardProps } from "@/types";
import { Button } from "../ui/button";
import { location } from "@/lib/utils";

const CompanyCardSavedPage = ({
  name,
  logo,
  city,
  state,
  ...
  return (
    <Link href={`/company-details/${id}`} className="w-full">
      <div className="flex h-full flex-col justify-between rounded-[10px] bg-white p-5 shadow dark:bg-darkBg-2">
...
export default CompanyCardSavedPage;
