...
const InlineJobCardSavedPage = ({ job }: { job: Job }) => {
  const {
    ...
    >
      <section className="flex justify-between">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="mb-1.5 w-[150px] truncate text-base font-bold leading-normal text-black dark:text-white">
              {formattedJobTitle}
            </div>
...
export default InlineJobCardSavedPage;
